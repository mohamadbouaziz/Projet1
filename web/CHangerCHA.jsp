		...
		<div class="container">
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					%>
						<tr>
							<td><%= v.getNUMERO_CHAMBRE1() %></td>
							<td><%= v.getNUMERO_CHAMBRE2() %></td>
                                                        <td><%= v.getcommentaire() %></td>
                                                        <td>
                                                       <form method="POST" action="suppdemande1" >
                                                                        <input type="submit" value="Supprimer" class="btn btn-outline-info">
                                                                       
                                                                        <input type="hidden" name="NUMERO_CHAMBRE1" value="<%=v.getNUMERO_CHAMBRE1()%>">
                                                                        <input type="hidden" name="NUMERO_CHAMBRE2" value="<%=v.getNUMERO_CHAMBRE2()%>">
                                                        ...
                                                        <td>
                                                           <form method="POST" action="accepte" > 
                                                            <input id="button1"   class="btn btn-success" type="submit" value="Accepter">
                                                            <input type="hidden" name="NUMERO_CHAMBRE1" value="<%=v.getNUMERO_CHAMBRE1()%>">
                                                             <input type="hidden" name="NUMERO_CHAMBRE2" value="<%=v.getNUMERO_CHAMBRE2()%>">
                                                             <input type="hidden" name="ETAT" value="<%=v.getetat()%>">
                                                           </form>
                                                        ...
                                                        <td>
                                                            <form method="POST" action="refuse" > 
                                                                ...
                                                                <input type="hidden" name="NUMERO_CHAMBRE2" value="<%=v.getNUMERO_CHAMBRE2()%>">
                                                                <input type="hidden" name="ETAT" value="<%=v.getetat()%>">
                                                            <input id="button2" class="btn btn-danger" type="submit" value="Refuser">
                                                            </form>
                                                        </td>
